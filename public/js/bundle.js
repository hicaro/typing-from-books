...
var _Box = require('./components/Box.vue');

var _Box2 = _interopRequireDefault(_Box);

var _Book = require('./components/Book.vue');
...
exports.default = {
  name: 'app',
  components: {
    Box: _Box2.default, Book: _Book2.default
  },
  data: function data() {
    return {
      chars: [],
  ...
  computed: {
    timeReport: function timeReport() {
      var minutes = parseInt(this.totalTime / 60);
  ...
  methods: {
    ...
    fetchExcerpt: function fetchExcerpt() {
      var _this = this;
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"frame",staticClass:"frame"},_vm._l((_vm.letters),function(letter,lc){return _c('span',{class:{current: _vm.letterCount == lc && _vm.focusIn,
                      correct: _vm.letterCount > lc && _vm.status[lc],
...
},{"./App.vue":31,"vue/dist/vue.min.js":29}]},{},[34])
